...
\begin{frame}[fragile]{3. Strutture Dati per la Concorrenza}
...
\begin{frame}[fragile]{4. Inizializzazione del Pool}
...
\begin{frame}[fragile]{5. Il Pattern Produttore-Consumatore}
    \begin{columns}
...
\begin{frame}[fragile]{6. Shutdown Sicuro e Gestione Semafori}
...
\begin{frame}[fragile]{7. Thread Safety: Il Database in Memoria}
...
\begin{frame}[fragile]{8. Sincronizzazione ed Eliminazione Atomica}
...
\begin{frame}{9. Specifiche API REST (CRUD)}
    \centering
...
\begin{frame}{10. Ottimizzazioni Architetturali}
...
\begin{frame}{11. Sicurezza e Gestione Vulnerabilità}
...
\begin{frame}{12. Analisi e Load Testing}
...
\begin{frame}{13. Conclusioni e Sviluppi Futuri}
