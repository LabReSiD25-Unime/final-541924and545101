...
\begin{frame}{5. Specifiche API REST (CRUD)}
    ...
    \begin{block}{Autenticazione}
        Le rotte di inserimento e modifica richiedono un header \texttt{Authorization: Basic} che viene confrontato nativamente in C con il token in Base64 prima di rilasciare l'accesso.
    \end{block}
\end{frame}
