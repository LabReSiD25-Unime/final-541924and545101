...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth, trim=0 40 0 40, clip]{../assets/wireshark_handshake.png}
    \caption{Tracciato Wireshark: Handshake a tre vie (SYN, SYN-ACK, ACK) su interfaccia Loopback.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth, trim=0 20 0 20, clip]{../assets/wireshark_unauthorized.png}
        \caption{Risposta 401 Unauthorized.}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth, trim=0 20 0 20, clip]{../assets/wireshark_post.png}
        \caption{Dettaglio Basic Auth e parametri POST.}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth, trim=0 40 0 40, clip]{../assets/wireshark_get_json.png}
    \caption{Visualizzazione della risposta JSON (200 OK) nell'inspector di Wireshark.}
    \label{fig:wireshark_json}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth, trim=0 40 0 40, clip]{../assets/wireshark_413.png}
    \caption{Validazione della sicurezza: il server rifiuta un payload eccessivo con errore 413.}
    \label{fig:wireshark_413}
\end{figure}
